...
public class SMSSchedule implements javax.servlet.ServletContextListener {
	...
	public void sendSMS() throws Exception {
        ...
        for(int i=0; i<scheduleList.size(); i++) {
        	...
        	userName= sendSMSForm.getUserName();
 			...
 			try {
			  ...
			  try {
    				try {					
    					...
    					sendSMSDB.UpdateSMSSchedule(custID, message, sending, dateTime, unit, cost, userName);
...
public void sendSMSEveryDay() throws Exception {
        ...
        chkTime = sendSMSDB.chkTimeSMS(time);
        
        if(chkTime==true){
        
        List scheduleList = sendSMSDB.findEveryDaySMS();
