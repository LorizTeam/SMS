...
<head>
	...
	function getTypeCustomer(tcustID, tcustName) {
				document.typeCustomerForm.groupID.value = tcustID;	
				document.typeCustomerForm.groupName.value = tcustName;	
	}
	</script>
...
<html:form action="/typeCustomer" method="POST">
        <!-- Page Content -->
        <div id="page-wrapper">
                		...
                		<div class="col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3 table-responsive">
                			<table class="table table-bordered table-striped table-hover" id="dataTables-customer">
                				...
                				<tbody>
									...
									int x = 0;
									for (Iterator iter = TpyeCustomerList.iterator(); iter.hasNext();) {
							  			x++;
							  			TypeCustomerForm custList = (TypeCustomerForm) iter.next();
					
									%>
									<tr>
										<td align="center"><%=x%></td>
										<td align="center"><a href="javascript:getTypeCustomer('<%=custList.getGroupID()%>','<%=custList.getGroupName()%>');"><%=custList.getGroupName()%></a></td>
										<td align="center"><input type="checkbox" id="chk1" name="chk1" value="<%=custList.getGroupID()%>"></td>
									</tr>
									<%		}
							 			} else {
									%>
